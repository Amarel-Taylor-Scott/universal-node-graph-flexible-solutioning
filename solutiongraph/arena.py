...
UNIVERSAL_DAG_ARENA = ArenaCatalog(
    (
        ...
        _task(
            ...
            ("contract", "ingest", "segment", "index", "retrieve", "rerank", "answer", "ground", "verify"),
            ("answer correctness", "citation validity", "retrieval recall", "unsupported claim rate", "freshness"),
        ...
        _task(
            ...
            ("intake", "extract", "retrieve policy", "corroborate", "adjudicate", "review", "settle", "audit"),
            ("decision accuracy", "benefit reconciliation", "evidence coverage", "review calibration", "cycle time"),
        ...
        _task(
            ...
            ("observe", "resolve identity", "features", "rules", "anomaly", "model", "combine", "decide", "learn"),
        ...
        _task(
            ...
            ("scope", "collect", "normalize", "enrich", "activity graph", "hypotheses", "contain", "recover"),
            ("detection quality", "evidence integrity", "time to contain", "false-positive rate", "recovery verification"),
            "template.cybersecurity-investigation",
            external=("Execution requires explicit defensive authority and access-controlled telemetry connectors."),
        ...
        _task(
            ...
            ("map", "collect", "authenticate", "sample", "test", "cross-check", "remediate", "attest"),
            ("control coverage", "evidence authenticity", "test reproducibility", "exception closure", "freshness"),
        ...
        _task(
            ...
            ("ingest", "validate geometry", "transform CRS", "index", "spatial join", "analyze", "uncertainty", "publish"),
            ("geometry validity", "coverage", "join loss", "positional error", "numerical accuracy"),
        ...
        _task(
            ...
            ("decode", "validate", "enhance", "activity", "diarize", "transcribe", "align", "verify", "redact"),
            ("word error rate", "alignment error", "speaker error", "policy recall", "signal quality"),
        ...
        _task(
            ...
            ("state", "forecast", "scenarios", "constraints", "optimize", "stress", "approve", "execute", "replan"),
        ...
        _task(
            ...
            ("formalize", "validate", "presolve", "decompose", "solve", "refine", "verify", "publish", "monitor"),
        ...
        _task(
            ...
            ("assess", "map", "prepare", "snapshot", "backfill", "capture changes", "reconcile", "shadow", "cutover"),
            ("row and value reconciliation", "replication lag", "workload compatibility", "downtime", "rollback readiness"),
            "template.database-migration",
            external=("Live migration requires scoped source/target credentials and explicit cutover authority."),
        ...
        _task(
            ...
            ("instrument", "collect", "verify telemetry", "detect", "correlate", "diagnose", "mitigate", "recover", "learn"),
        ...
        _task(
            ...
            ("policy", "decode", "language", "signals", "rules", "models", "cross-check", "decide", "review", "appeal"),
            ("category precision and recall", "severity calibration", "appeal overturn rate", "consistency", "latency"),
