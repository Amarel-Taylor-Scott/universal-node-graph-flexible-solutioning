...
| Data-science design atlas | Reference decision system; four graph stages/five node implementations executable; techniques catalog-only | 31 task archetypes, 28 packs, 112 all-visible questions, five source-bound nodes/34 bindings, authority-separated human or LLM planning, digest-bound answers, strict reports, and evidence-derived C0–C7 assessment; 618 owner-supplied techniques are C1 catalog entries and do not claim executable implementations |
